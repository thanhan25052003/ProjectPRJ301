<%-- 
    ...
    Created on : Mar 1, 2024, 11:54:55 PM
    Author     : admin
--%>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-5 col-12">
                <div class="header-search">
                    <form action="home?search=searchByName" method="GET">
                        <input type="hidden" name="search" value="searchByName"/>
                        <input type="text" placeholder="Search entire store here..." name="keyword"/>
                        <a href="#" onclick="return this.closset('form').submit()"><i class="fa fa-search"></i></a>
                    </form>
                </div>
            </div>
